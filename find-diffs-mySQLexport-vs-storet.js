...
var aSamples = rsql.readWebExportFile('/Users/bill/Development/water-quality/db/reports/hui-west-maui-thru-18-01-09.tsv');
console.log("aSamples " + util.inspect(aSamples, false, null));
var numASamples = Object.keys(aSamples).length;


var bSamples = rspc.readStoretFile('/Users/bill/Development/water-quality-data/storet/physical-chemical.csv');
